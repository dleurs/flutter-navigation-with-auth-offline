...
import 'package:starter/src/core/authentication/authentication_manager.dart';
import 'package:starter/src/model/authentication/token.dart';
import 'package:starter/src/resource/login_repository.dart';
  ...
  Stream<AuthenticationState> mapEventToState(
    ...
    if (event is LoginEvent) {
      try {
        ...
        await AuthenticationManager.instance.doLogin(event.login, event.password, token);
